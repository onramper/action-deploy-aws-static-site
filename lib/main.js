...
function execCDK(args, env) {
    (0, child_process_1.execSync)(`(cd ${removeLastDir(__dirname)} && PATH="${removeLastDir(process.execPath)}:$PATH" node node_modules/aws-cdk-lib/index.js ${args})`, {
        env,
    });
}
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const CDK_DEFAULT_REGION = core.getInput("CDK_DEFAULT_REGION");
