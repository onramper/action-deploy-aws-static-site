...
class StaticPageStack extends cdk.Stack {
    constructor(scope, id, { stackName, folder, fullDomain, }) {
        ...
        const subdomain = (0, utils_1.getSubdomain)(fullDomain);
        const domain = (0, utils_1.getDomain)(fullDomain);
        const zone = (0, utils_1.getDNSZone)(this, domain);
        const certificate = (0, utils_1.getCertificate)(this, fullDomain, zone);
        ...
        (0, utils_1.setDNSRecord)(this, subdomain, zone, distribution);
