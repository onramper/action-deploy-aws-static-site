...
declare const _default: {
    ...
    'nested stack within a nested stack references a resource in a sibling top-level stack'(test: Test): void;
    ...
    'references to a resource from a deeply nested stack'(test: Test): void;
    'bottom nested stack consumes value from a top-level stack through a parameter in a middle nested stack'(test: Test): void;
};
export = _default;
