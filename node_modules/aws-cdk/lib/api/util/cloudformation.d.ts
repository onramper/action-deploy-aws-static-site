...
export declare class TemplateParameters {
     ...
     * supplied.
     */
    toStackParameters(updates: Record<string, string | undefined>): StackParameters;
    /**
     ...
     * supplied.
     */
    diff(updates: Record<string, string | undefined>, previousValues: Record<string, string>): StackParameters;
}
export declare class StackParameters {
    ...
    private _changes;
    constructor(params: Record<string, TemplateParameter>, updates: Record<string, string | undefined>, previousValues?: Record<string, string>);
    /**
