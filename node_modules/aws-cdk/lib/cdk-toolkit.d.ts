...
import { BootstrappingParameters } from './api/bootstrap';
...
export declare class CdkToolkit {
     ...
     */
    bootstrap(environmentSpecs: string[], toolkitStackName: string | undefined, roleArn: string | undefined, useNewBootstrapping: boolean, force: boolean | undefined, props: BootstrappingParameters): Promise<void>;
